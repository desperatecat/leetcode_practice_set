class Solution {
    public String addBinary(String a, String b) {
        ...
        while (i >= 0 || j >= 0) {
            ...
            sb.append(sum % 2); //if sum==2 or sum==0 append 0 cause 1+1=0 in this case as this is base 2 (just like 1+9 is 0 if adding ints in columns); if sum==1 then append 1
            carry = sum / 2; //if sum==2 we have a carry, else if sum ==1, no carry because 1/2 rounds down to 0 
        }
        if (carry != 0) sb.append(carry); //if finally we had carry, add it
